              ...
              <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">Across all sections</p>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between items-center pb-3 border-b border-gray-200">
                      ...
                      <span className="font-bold text-gray-800">
                        {productionData?.working_days || 0}
                      </span>
                    </div>

                    <div className="flex justify-between items-center pb-3 border-b border-gray-200">
                      <span className="text-gray-700">Avg. Batches/Day</span>
                      <span className="font-bold text-gray-800">
                        {productionData
                          ? Math.round(productionData.total_batch / productionData.working_days)
                          : 0}
                      </span>
                    </div>

                    <div className="flex justify-between items-center pb-3 border-b border-gray-200">
                      <span className="text-gray-700">Avg. Value/Batch</span>
                      <span className="font-bold text-gray-800">
                        {productionData?.total_batch
                          ? formatCurrency(
                              productionData.monthly_total / productionData.total_batch
                            )
                          : '৳0'}
                      </span>
                    </div>
                    ...
                    <div className="flex justify-between items-center">
                      <span className="text-gray-700">Total Cartons</span>
                      <span className="font-bold text-gray-800">
                        {formatNumber(productionData?.total_carton || 0)}
                      </span>
                    </div>

                    <div className="mt-6 p-4 bg-blue-50 rounded-lg">
                      <p className="text-sm text-blue-700">
                        <span className="font-semibold">Note:</span> Based on production data for{' '}
